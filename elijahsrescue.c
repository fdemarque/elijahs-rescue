...
void play(struct game *game)
{
    ...
    while (game->thisPhase == 3)
    {
        ...
        case 2:
            ...
            {
                char *phrases[] = {
                    "Martha: You know who I am.\n",
                    "Martha: I missed you so much my son.\n",
                    "Martha: Look what they've done to you my boy.\n",
                    "Martha: Don't blame on you for it's not your fault, but listen to me...\n",
                    "Martha: You were loved with a love I didn't even knew I could feel... And you'll always be.\n",
                    "Martha: Mom wants you to be brave, and fight for us up there.\n",
                    "Martha: Life is beautiful and meaningful because it ends.\n",
                    "Martha: There's is one last thing I want you to know before our last goodbye.\n",
                    "Martha: ...\n",
                    "Martha: You are stronger than him, FIGHT!\n"};
                ...
                for (i = 0; i <= 9; i++)
                {
                    ...
                    if (i < 9)
                    {
                        ...
                        if (answer == 1 && game->elijah.sanity > 0)
                        {
                            ...
                            game->elijah.sanity = game->elijah.sanity - 10;
                            printf("Actual sanity is %d\n\n", game->elijah.sanity);
                        }
                        else if (answer == 2 && game->elijah.sanity > 0)
                        {
    ...
    while (game->thisPhase == 4)
    {
        ...
        case 3:
            ...
            char *attacks[] = {
                "Hajile: THE WORLD OF THE LIVING HAS REJECTED ME!\n",
                "Hajile: THE WORLD OF THE LIVING SEES ME AS A FOOL!\n",
                "Hajile: OUR MOTHER IS GONE, I AM NOTHING WITHOUT HER!\n",
                "Hajile: I CAN'T NO LONGER FACE THE WORLD OF THE LIVING!\n"};

            char *responses[] = {
                "Elijah: We rejected ourselves, we... I must accept myself.\n",
                "Elijah: And how WE see ourselves? We... I should be fighting FOR me!.\n",
                "Elijah: She is gone, and this is the hardest part of our fight, but it's also a reason to stand FOR her because she fought for me!\n",
                "Elijah: You can face EVERYTHING, I can face EVERYTHING, WE ARE ONE, AND WE DESERVE OUR PLACE UNDERNEATH THE SUN!\n"};
